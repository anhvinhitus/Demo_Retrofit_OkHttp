...
class Intent {
	static final String START_INTENT = "vn.com.vng.debugviewer.intent.START";
	static final String SAVE_INTENT = "vn.com.vng.debugviewer.intent.SAVE";
	static final String SHARE_INTENT = "vn.com.vng.debugviewer.intent.SHARE";
	public static final String DEBUGVIEWER_INTENT = "vn.com.vng.debugviewer.intent.DEBUG";
