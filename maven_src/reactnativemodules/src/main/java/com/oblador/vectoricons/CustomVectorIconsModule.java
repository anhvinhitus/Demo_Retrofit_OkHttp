...
/**
 * Created by hieuvm on 11/17/16.
 */

public class CustomVectorIconsModule extends ReactContextBaseJavaModule {

    private static final Map<String, Typeface> sTypefaceCache = new HashMap<String, Typeface>();

    public static final String REACT_CLASS = "RNCustomVectorIconsModule";
    ...
    public CustomVectorIconsModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
