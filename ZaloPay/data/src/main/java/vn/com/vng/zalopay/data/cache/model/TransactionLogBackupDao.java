...
/** 
 * DAO for table "TRANSACTION_LOG_BACKUP".
*/
public class TransactionLogBackupDao extends AbstractDao<TransactionLogBackup, Long> {

    public static final String TABLENAME = "TRANSACTION_LOG_BACKUP";

    /**
     * Properties of entity TransactionLogBackup.<br/>
    ...
    public TransactionLogBackupDao(DaoConfig config) {
        super(config);
    }
    
    public TransactionLogBackupDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRANSACTION_LOG_BACKUP\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRANSACTION_LOG_BACKUP\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TransactionLogBackup entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TransactionLogBackup entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.transid);
        stmt.bindLong(2, entity.appid);
    ...
    @Override
    public TransactionLogBackup readEntity(Cursor cursor, int offset) {
        TransactionLogBackup entity = new TransactionLogBackup();
        readEntity(cursor, entity, offset);
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, TransactionLogBackup entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TransactionLogBackup entity, long rowId) {
        entity.transid = rowId;
        return rowId;
    }
    
    @Override
    public Long getKey(TransactionLogBackup entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(TransactionLogBackup entity) {
