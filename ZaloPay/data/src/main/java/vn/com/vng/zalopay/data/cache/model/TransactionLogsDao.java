...
/** 
 * DAO for table "TRANSACTION_LOGS".
*/
public class TransactionLogsDao extends AbstractDao<TransactionLogs, Long> {

    public static final String TABLENAME = "TRANSACTION_LOGS";

    /**
     * Properties of entity TransactionLogs.<br/>
    ...
    */
    ...
    public TransactionLogsDao(DaoConfig config) {
        super(config);
    }
    
    public TransactionLogsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRANSACTION_LOGS\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRANSACTION_LOGS\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TransactionLogs entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TransactionLogs readEntity(Cursor cursor, int offset) {
        TransactionLogs entity = new TransactionLogs( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TransactionLogs entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TransactionLogs entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TransactionLogs entity) {
        if(entity != null) {
