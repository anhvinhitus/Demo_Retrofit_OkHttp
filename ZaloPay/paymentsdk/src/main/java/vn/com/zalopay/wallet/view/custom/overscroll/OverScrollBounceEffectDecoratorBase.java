...
import vn.com.zalopay.wallet.view.custom.overscroll.adapters.IOverScrollDecoratorAdapter;

import static vn.com.zalopay.wallet.view.custom.overscroll.IOverScrollState.STATE_BOUNCE_BACK;
import static vn.com.zalopay.wallet.view.custom.overscroll.IOverScrollState.STATE_DRAG_END_SIDE;
import static vn.com.zalopay.wallet.view.custom.overscroll.IOverScrollState.STATE_DRAG_START_SIDE;
import static vn.com.zalopay.wallet.view.custom.overscroll.IOverScrollState.STATE_IDLE;
import static vn.com.zalopay.wallet.view.custom.overscroll.ListenerStubs.OverScrollStateListenerStub;
import static vn.com.zalopay.wallet.view.custom.overscroll.ListenerStubs.OverScrollUpdateListenerStub;
 ...
 */
public abstract class OverScrollBounceEffectDecoratorBase implements vn.com.zalopay.wallet.view.custom.overscroll.IOverScrollDecor, View.OnTouchListener {
    ...
    protected vn.com.zalopay.wallet.view.custom.overscroll.IOverScrollStateListener mStateListener = new OverScrollStateListenerStub();
    protected vn.com.zalopay.wallet.view.custom.overscroll.IOverScrollUpdateListener mUpdateListener = new OverScrollUpdateListenerStub();
    ...
    protected interface IDecoratorState {
         ...
         * are as specified in {@link me.everything.android.ui.overscroll.IOverScrollState}.
         *
