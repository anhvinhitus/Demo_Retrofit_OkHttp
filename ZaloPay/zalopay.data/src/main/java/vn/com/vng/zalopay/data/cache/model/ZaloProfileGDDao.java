...
/** 
 * DAO for table "ZALO_PROFILE_GD".
*/
public class ZaloProfileGDDao extends AbstractDao<ZaloProfileGD, Long> {

    public static final String TABLENAME = "ZALO_PROFILE_GD";

    /**
     * Properties of entity ZaloProfileGD.<br/>
    ...
    public ZaloProfileGDDao(DaoConfig config) {
        super(config);
    }
    
    public ZaloProfileGDDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ZALO_PROFILE_GD\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ZALO_PROFILE_GD\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ZaloProfileGD entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ZaloProfileGD entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(ZaloProfileGD entity) {
    ...
    @Override
    public ZaloProfileGD readEntity(Cursor cursor, int offset) {
        ZaloProfileGD entity = new ZaloProfileGD();
        readEntity(cursor, entity, offset);
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, ZaloProfileGD entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ZaloProfileGD entity, long rowId) {
        entity.zaloId = rowId;
        return rowId;
    }
    
    @Override
    public Long getKey(ZaloProfileGD entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(ZaloProfileGD entity) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM ZALO_PROFILE_GD T");
    ...
    protected ZaloProfileGD loadCurrentDeep(Cursor cursor, boolean lock) {
        ZaloProfileGD entity = loadCurrent(cursor, 0, lock);
    ...
    public ZaloProfileGD loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<ZaloProfileGD> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<ZaloProfileGD> list = new ArrayList<ZaloProfileGD>(count);
    ...
    protected List<ZaloProfileGD> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<ZaloProfileGD> queryDeep(String where, String... selectionArg) {
