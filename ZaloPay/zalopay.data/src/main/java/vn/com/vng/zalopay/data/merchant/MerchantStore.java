...
public interface MerchantStore {
    ...
    interface RequestService {
        @API_NAME(https = ZPEvents.API_UMMERCHANT_GETMERCHANTUSERINFO, connector = ZPEvents.CONNECTOR_UMMERCHANT_GETMERCHANTUSERINFO)
        ...
        @API_NAME(https = ZPEvents.API_UMMERCHANT_GETLISTMERCHANTUSERINFO, connector = ZPEvents.CONNECTOR_UMMERCHANT_GETLISTMERCHANTUSERINFO)
