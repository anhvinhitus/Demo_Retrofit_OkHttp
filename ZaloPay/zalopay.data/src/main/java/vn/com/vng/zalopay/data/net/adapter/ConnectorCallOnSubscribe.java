 ...
 */
final class ConnectorCallOnSubscribe<T> implements Observable.OnSubscribe<Response<T>> {
    private final Context mContext;
    private final Call<T> mOriginalCall;
    private final int mApiClientId;

    ConnectorCallOnSubscribe(Context context, Call<T> originalCall, int apiClientId) {
