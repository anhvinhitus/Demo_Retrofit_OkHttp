...
// Source file: zpmsguser.proto at 154:1
...
public final class PaymentRequestMessage extends Message<PaymentRequestMessage, PaymentRequestMessage.Builder> {
  ...
  public PaymentRequestMessage(Long requestid, String domain, String method, Integer port, String path, List<PairKeyValue> params, List<PairKeyValue> headers) {
    this(requestid, domain, method, port, path, params, headers, ByteString.EMPTY);
  }

  public PaymentRequestMessage(Long requestid, String domain, String method, Integer port, String path, List<PairKeyValue> params, List<PairKeyValue> headers, ByteString unknownFields) {
