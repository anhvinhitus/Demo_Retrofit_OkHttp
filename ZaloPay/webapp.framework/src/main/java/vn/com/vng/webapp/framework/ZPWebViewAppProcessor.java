...
public class ZPWebViewAppProcessor extends WebViewClient {
    ...
    private NativeModule mDefaultNativeModule;
    ...
    public ZPWebViewAppProcessor(ZPWebViewApp pWebView,
        ...
        mCommunicationHandler.registerNativeModule(mDefaultNativeModule);
    }
    ...
    public void registerNativeModule(@NonNull NativeModule nativeModule) {
        mCommunicationHandler.registerNativeModule(nativeModule);
    }

    public void unregisterNativeModule(@NonNull NativeModule nativeModule) {
        mCommunicationHandler.unregisterNativeModule(nativeModule);
    }
...
//        }
    ...
    public void onDestroyView() {
        ...
        mCommunicationHandler.unregisterNativeModule(mDefaultNativeModule);
