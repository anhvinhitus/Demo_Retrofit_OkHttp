...
public class SwipeLayout extends FrameLayout {
    ...
    public int mDragDistance = 0;
    private LinkedHashMap<DragEdge, View> mDragEdges = new LinkedHashMap<>();
    private ShowMode mShowMode;

    protected float[] mEdgeSwipesOffset = new float[4];
    ...
    protected Map<View, Rect> mViewBoundCache = new HashMap<>();//save all children's bound, restore in onLayout
    ...
    public interface SwipeListener {
        ...
        void onViewPositionChanged(SwipeLayout layout, View changedView, int left, int top, int dx, int dy);
    }
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (changedView == surfaceView) {
                ...
                for (SwipeListener l : mSwipeListeners) {
                    l.onViewPositionChanged(SwipeLayout.this, changedView, left, top, dx, dy);
                }
    ...
    private void updateBottomViews() {
        ...
        if (currentBottomView != null) {
            if (mCurrentDragEdge == DragEdge.Left || mCurrentDragEdge == DragEdge.Right) {
                mDragDistance = currentBottomView.getMeasuredWidth() - (int) getCurrentOffset();
            } else {
                mDragDistance = currentBottomView.getMeasuredHeight() - (int) getCurrentOffset();
            }
        }
