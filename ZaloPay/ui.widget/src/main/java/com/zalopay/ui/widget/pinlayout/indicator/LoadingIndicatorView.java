...
import com.zalopay.ui.widget.dialog.indicator.BallPulseIndicator;
import com.zalopay.ui.widget.dialog.indicator.BaseIndicatorController;
...
public class LoadingIndicatorView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        DEFAULT_SCREEN = getResources().getDimensionPixelSize(R.dimen.size_dot);
        a.recycle();
        mPaint = new Paint();
