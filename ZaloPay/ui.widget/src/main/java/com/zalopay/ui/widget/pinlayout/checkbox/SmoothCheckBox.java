...
package com.zalopay.ui.widget.pinlayout.checkbox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED = Color.parseColor("#008fe5");
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width_c, dp2px(getContext(), 0));
        ta.recycle();
    ...
    private int dp2px(Context pContext, int dpValue) {
        return (int) pContext.getResources().getDisplayMetrics().density * dpValue;
    }
