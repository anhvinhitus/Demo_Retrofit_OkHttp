...
public class ErrorView extends LinearLayout {
    ...
    private void init(AttributeSet attrs, int defStyle, int defStyleRes) {
        ...
        try {
            ...
            ColorStateList retryButtonTextColor = a.getColorStateList(R.styleable.ErrorView_ev_retryButtonTextColor);
            ...
            mRetryButton.setTextColor(retryButtonTextColor != null ? retryButtonTextColor : ColorStateList.valueOf(0xFF000000));
