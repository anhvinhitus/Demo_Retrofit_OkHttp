...
import vn.com.zalopay.wallet.repository.bankaccount.BankAccountRepository;
...
public class BankAccountRepositoryModule {
    ...
    @Provides
    @Singleton
    public BankAccountStore.Repository provideBankAccountRepository(BankAccountStore.BankAccountService bankAccountService, BankAccountStore.LocalStorage localStorage) {
        return new BankAccountRepository(bankAccountService, localStorage);
    }
}
