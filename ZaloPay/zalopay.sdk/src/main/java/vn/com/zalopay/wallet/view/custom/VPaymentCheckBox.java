...
@SuppressLint("NewApi")
public class VPaymentCheckBox extends View {
    private final String TAG = VPaymentCheckBox.class.getName();
    ...
    public VPaymentCheckBox(Context context) {
        this(context, null);
    }

    public VPaymentCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.VPaymentCheckBox);
            mStrokeWidth = (int) array.getDimension(R.styleable.VPaymentCheckBox_stroke__border_width, dip(mStrokeWidth));
            mStrokeColor = array.getColor(R.styleable.VPaymentCheckBox_stroke_color, mStrokeColor);
            mCircleColor = array.getColor(R.styleable.VPaymentCheckBox_circle_color, mCircleColor);
            array.recycle();
        } else {
