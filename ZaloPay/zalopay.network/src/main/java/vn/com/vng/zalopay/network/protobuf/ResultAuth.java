...
// Source file: zpmsguser.proto at 123:1
...
public final class ResultAuth extends Message<ResultAuth, ResultAuth.Builder> {
  ...
  public ResultAuth(Long usrid, Integer result, Integer code, String msg) {
    this(usrid, result, code, msg, ByteString.EMPTY);
  }

  public ResultAuth(Long usrid, Integer result, Integer code, String msg, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<ResultAuth, Builder> {
    ...
    public ResultAuth build() {
      return new ResultAuth(usrid, result, code, msg, super.buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_ResultAuth extends ProtoAdapter<ResultAuth> {
    ...
    public int encodedSize(ResultAuth value) {
      return (value.usrid != null ? ProtoAdapter.UINT64.encodedSizeWithTag(1, value.usrid) : 0)
          + (value.result != null ? ProtoAdapter.INT32.encodedSizeWithTag(2, value.result) : 0)
          + (value.code != null ? ProtoAdapter.INT32.encodedSizeWithTag(3, value.code) : 0)
          + (value.msg != null ? ProtoAdapter.STRING.encodedSizeWithTag(4, value.msg) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, ResultAuth value) throws IOException {
      if (value.usrid != null) ProtoAdapter.UINT64.encodeWithTag(writer, 1, value.usrid);
      if (value.result != null) ProtoAdapter.INT32.encodeWithTag(writer, 2, value.result);
      if (value.code != null) ProtoAdapter.INT32.encodeWithTag(writer, 3, value.code);
      if (value.msg != null) ProtoAdapter.STRING.encodeWithTag(writer, 4, value.msg);
    ...
    public ResultAuth decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 4: builder.msg(ProtoAdapter.STRING.decode(reader)); break;
          default: {
