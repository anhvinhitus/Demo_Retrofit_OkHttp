...
// Source file: zpmsguser.proto at 226:1
...
public final class PaymentResponseMessage extends Message<PaymentResponseMessage, PaymentResponseMessage.Builder> {
  ...
  public PaymentResponseMessage(Long requestid, Integer resultcode, String resultdata, Long usrid, Integer sourceid) {
    this(requestid, resultcode, resultdata, usrid, sourceid, ByteString.EMPTY);
  }

  public PaymentResponseMessage(Long requestid, Integer resultcode, String resultdata, Long usrid, Integer sourceid, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<PaymentResponseMessage, Builder> {
    ...
    public PaymentResponseMessage build() {
      return new PaymentResponseMessage(requestid, resultcode, resultdata, usrid, sourceid, super.buildUnknownFields());
    }
  }
