 ...
 * *
 */
class WebAppPresenter extends AbstractWebAppPresenter<IWebAppView> {

    @Inject
    WebAppPresenter(AccountStore.Repository accountRepository, Navigator navigator, AppResourceStore.Repository appResourceRepository, MerchantStore.Repository merchantRepository) {
