...
public class MenuItemUtil {
    ...
    static {
        ...
        mMenuItems.add(new MenuItem(HOME_ID, MenuItemType.ITEM, R.drawable.ic_trangchu, "Trang Chủ"));
        mMenuItems.add(new MenuItem(NOTIFICATION_ID, MenuItemType.ITEM, R.drawable.ic_thongbao, R.drawable.ic_arrow_right, "Thông Báo", false));

        mMenuItems.add(new MenuItem(TRANSACTION_ID, MenuItemType.HEADER, null, "GIAO DỊCH"));
        mMenuItems.add(new MenuItem(SCAN_QR_ID, MenuItemType.ITEM, R.drawable.ic_qrcode, "Quét Mã QR"));
        mMenuItems.add(new MenuItem(DEPOSIT_ID, MenuItemType.ITEM, R.drawable.ic_naptien, "Nạp Tiền"));
        mMenuItems.add(new MenuItem(TRANSFER_ID, MenuItemType.ITEM, R.drawable.ic_chuyentien, "Chuyển Tiền"));
        mMenuItems.add(new MenuItem(TRANSACTION_HISTORY_ID, MenuItemType.ITEM, R.drawable.ic_lichsu, R.drawable.ic_arrow_right, "Lịch Sử Giao Dịch", false));

        mMenuItems.add(new MenuItem(APPLICATION_ID, MenuItemType.HEADER, null, "ỨNG DỤNG"));
        mMenuItems.add(new MenuItem(FAQ_ID, MenuItemType.ITEM, R.drawable.ic_faq, "FAQ"));
        mMenuItems.add(new MenuItem(CONTACT_SUPPORT_ID, MenuItemType.ITEM, R.drawable.ic_lienhe, "Liên Hệ Hỗ Trợ"));
        mMenuItems.add(new MenuItem(APPLICATION_INFO_ID, MenuItemType.ITEM, R.drawable.ic_thongtin, "Thông Tin ứng Dụng"));
