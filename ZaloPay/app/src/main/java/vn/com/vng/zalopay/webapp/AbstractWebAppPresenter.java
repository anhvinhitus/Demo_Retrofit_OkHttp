...
abstract class AbstractWebAppPresenter<View extends IWebAppView> extends AbstractPaymentPresenter<View> implements WebBottomSheetDialogFragment.BottomSheetEventListener {
    ...
    protected final ProcessMessageListener mProcessMessageListener = new ProcessMessageListener(this);

    public AbstractWebAppPresenter(AccountStore.Repository accountRepository,
                                   Navigator navigator,
    ...
    private void getUserInfo(String zpName) {
        ...
        Subscription subscription = mAccountRepository.getUserInfoByZaloPayName(zpName)
                ...
                .subscribe(new AbstractWebAppPresenter.UserInfoSubscriber(zpName));
