...
//        tvDisplayName.setText(person.displayName);
...
//        btnContinue.setEnabled(mAmount > 0 && !TextUtils.isEmpty(person.zaloPayId));
//    }
//
//    @Override
//    public void onGetMappingUserSuccess(MappingZaloAndZaloPay userMapZaloAndZaloPay) {
//        person.zaloPayId = userMapZaloAndZaloPay.getZaloPayId();
//        try {
