 ...
 * Handle data and logic in list payment apps
 */

public class HomeListAppPresenter extends AbstractPresenter<IHomeListAppView> implements IZaloPayPresenter<IHomeListAppView> {
    ...
    @Inject
    HomeListAppPresenter(Context context, MerchantStore.Repository mMerchantRepository,
                     EventBus eventBus,
    ...
    @Override
    public void attachView(IHomeListAppView iHomeListAppView) {
