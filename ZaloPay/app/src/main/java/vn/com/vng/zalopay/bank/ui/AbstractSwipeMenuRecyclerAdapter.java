...
/**
 * Created by longlv on 5/8/17.
 * Wrapper SwipeMenuAdapter
 */

public abstract class AbstractSwipeMenuRecyclerAdapter<T, VH extends RecyclerView.ViewHolder> extends SwipeMenuAdapter<VH> {
    ...
    public AbstractSwipeMenuRecyclerAdapter(Context context) {
