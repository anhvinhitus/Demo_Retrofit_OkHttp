...
class GoogleTagManagerBridge extends ReactContextBaseJavaModule {

    GoogleTagManagerBridge(ReactApplicationContext reactContext) {
        super(reactContext);
    }
   ...
   private final String E_CONTAINER_ALREADY_OPEN = "E_CONTAINER_ALREADY_OPEN";
    ...
    public void openContainerWithId(final String containerId, final Promise promise) {
        promise.reject(E_OPEN_CONTAINER_FAILED, new Throwable("Vui lòng liên hệ với team ZaloPay App để biết thêm chi tiết!"));
